...
If we consider total turnout to be union of Respect voting in both stages then one way to think about it is that 2/3rds + 1 of turnout is able to pass a proposal, which also means that 1/3rd of turnout is able to block it.
